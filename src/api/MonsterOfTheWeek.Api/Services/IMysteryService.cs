...
public interface IMysteryService
{
    ...
    Task<MysteryDetailResponse> CreateAsync(UpsertMysteryRequest request, CancellationToken cancellationToken);
    Task<MysteryDetailResponse?> UpdateAsync(Guid id, UpsertMysteryRequest request, CancellationToken cancellationToken);
